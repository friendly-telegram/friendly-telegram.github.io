...
It's very simple - paste this command into a Linux terminal (on Android use termux): ```$SHELL <($(which curl >/dev/null && echo curl -Ls || echo wget -qO-) https://git.io/JeOXn)```
