...
*(Multi-line expressions work fine here, as well as asyncio and im. Cool, isn't it?)*
...
[Syntax: `restart`]
   ...
   Restarts the userbot.Welcome file
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMDk4MzE1OSw2ODExNjAyODJdfQ==
-->